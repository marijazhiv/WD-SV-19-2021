let firebase2Url = "https://pozorista-a30a0-default-rtdb.europe-west1.firebasedatabase.app/";
...
buttonR.addEventListener("click", function validate() {
  if (
    ...
    korisnikk.brojTelefona=brojTelefona.value;

    let regfirebase= "https://pozorista-a30a0-default-rtdb.europe-west1.firebasedatabase.app/"
